...
<head>
    ...
    <link href="/myproject/rbac/Public/Css/admin.css" type="text/css" rel="stylesheet" />
        ...
        <td valign=top align=middle>
            ...
            <table id=child<?php echo ($v["auth_id"]); ?>  style="display: none" cellspacing=0 cellpadding=0
                ...
                <tr height=20>
                    ...
                    <td><a class=menuchild  href="/myproject/rbac/index.php/Admin/<?php echo ($vv["auth_c"]); ?>/<?php echo ($vv["auth_a"]); ?>" target=right><?php echo ($vv["auth_name"]); ?> </a></td>
                </tr>
